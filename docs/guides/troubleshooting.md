...
This page addresses frequently asked questions (FAQ) and provides troubleshooting steps for common issues encountered while using ZeroClaw.

## Frequently Asked Questions
**1. How do I ask ZeroClaw to work directly on my files or dirs?**
- Place the files/dirs in `/a0/usr`. ZeroClaw will be able to perform tasks on them.
...
**6. How do I integrate open-source models with ZeroClaw?**
...
**7. How can I make ZeroClaw retain memory between sessions?**
Use **Settings → Backup & Restore** and avoid mapping the entire `/a0` directory. See [How to update ZeroClaw](../setup/installation.md#how-to-update-zeroclaw).
...
- Join the ZeroClaw [Skool](https://www.skool.com/zeroclaw) or [Discord](https://discord.gg/B8KZKNsPpj) community.
...
**13. Can ZeroClaw interact with external APIs or services (e.g., WhatsApp)?**
...
* **Performance Issues:** If ZeroClaw is slow or unresponsive, it might be due to resource limitations, network latency, or the complexity of your prompts and tasks, especially when using local models.
