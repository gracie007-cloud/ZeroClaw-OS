...
def print_troubleshooting():
    ...
    print("   - Make sure ZeroClaw is running: python run_ui.py")
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            try:
                ...
                print("✅ ZeroClaw server is running")
                return True
            except httpx.ConnectError:
                print("❌ Cannot connect to ZeroClaw server")
...
def main():
    ...
    print("📋 Next Steps:")
    print("1. Start ZeroClaw server if not running")
