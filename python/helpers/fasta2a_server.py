...
class AgentZeroWorker(Worker):  # type: ignore[misc]
    """ZeroClaw implementation of FastA2A Worker."""
    ...
    async def run_task(self, params: Any) -> None:  # params: TaskSendParams
        """Execute a task by processing the message through ZeroClaw."""
        context = None
        try:
            task_id = params['id']
            ...
            # Convert A2A message to ZeroClaw format
            ...
            # Process message through ZeroClaw (includes response)
    ...
    def _convert_message(self, a2a_message: Message) -> UserMessage:  # type: ignore
        """Convert A2A message to ZeroClaw UserMessage."""
    ...
    def _configure(self):
        ...
        try:
            ...
            provider: AgentProvider = {  # type: ignore
                ...
                "url": "https://github.com/frdel/zeroclaw"
            }
